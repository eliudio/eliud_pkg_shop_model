...
class ProductImageCache implements ProductImageRepository {
  ...
  final Map<String?, ProductImageModel?> fullCache = {};

  ProductImageCache(this.reference);

  /// Add a ProductImageModel to the repository, cached
  @override
  ...
  /// Add a ProductImageEntity to the repository, cached
  @override
  ...
  /// Update a ProductImageEntity in the repository, cached
  @override
  ...
  /// Delete a ProductImageModel from the repository, cached
  @override
  ...
  /// Retrieve a ProductImageModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<ProductImageModel?>
  @override
  ...
  static Future<ProductImageModel> refreshRelations(
      ProductImageModel model) async {
