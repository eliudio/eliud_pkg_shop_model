...
class ShopCache implements ShopRepository {
  ...
  /// Retrieve a ShopModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<ShopModel?>
  @override
  ...
  @override
  Future<ShopEntity?> getEntity(String? id, {Function(Exception p1)? onError}) {
