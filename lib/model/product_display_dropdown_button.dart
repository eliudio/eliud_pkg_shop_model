...
typedef ProductDisplayChanged = Function(
  String? value,
  int? privilegeLevel,
);
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      value: value,
                      hint:
                          text(widget.app, context, 'Select a productDisplay'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'productDisplays', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
