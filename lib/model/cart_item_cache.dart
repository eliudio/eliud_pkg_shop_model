...
import 'package:eliud_pkg_shop_model/model/cart_item_repository.dart';
...
class CartItemCache implements CartItemRepository {
  ...
  /// Add a CartItemModel to the repository, cached
  @override
  ...
  /// Retrieve a CartItemModel with it's id, cached
  @override
  Future<CartItemModel?> get(String? id, {Function(Exception)? onError}) async {
  ...
  /// Retrieve list of List<CartItemModel?>
  @override
  ...
  @override
  Future<CartItemEntity?> getEntity(String? id,
