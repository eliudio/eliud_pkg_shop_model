...
import 'product_display_list_bloc.dart';
import 'product_display_list_event.dart';
...
class ProductDisplayComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app,
    ...
    return BlocProvider<ProductDisplayListBloc>(
...
class _SelectProductDisplayWidgetState
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
      ...
      BlocProvider.of<ProductDisplayListBloc>(context).add(
          ProductDisplayChangeQuery(
              newQuery: getComponentSelectorQuery(
                  _currentPrivilege, widget.app.documentID)));
    }
  }

  Widget theList(BuildContext context, List<ProductDisplayModel?> values) {
    var app = widget.app;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProductDisplayListBloc, ProductDisplayListState>(
      ...
      if ((state is ProductDisplayListLoaded) && (state.values != null)) {
