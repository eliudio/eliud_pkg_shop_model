...
typedef PayConfirmationChanged = Function(
  String? value,
  int? privilegeLevel,
);
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      value: value,
                      hint:
                          text(widget.app, context, 'Select a payConfirmation'),
                ...
                : dropdownButton<String>(
                    ...
                    items: items,
                    value: value,
                    hint: text(widget.app, context, 'Select a payConfirmation'),
                    onChanged: _onValueChange,
                  ),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'payConfirmations', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<PayConfirmationListBloc>(context)
        .add(PayConfirmationChangeQuery(
