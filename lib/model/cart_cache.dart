...
class CartCache implements CartRepository {
  ...
  /// Add a CartModel to the repository, cached
  @override
  ...
  /// Retrieve a CartModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<CartModel?>
  @override
  ...
  @override
  Future<CartEntity?> getEntity(String? id, {Function(Exception p1)? onError}) {
