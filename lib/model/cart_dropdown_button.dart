...
typedef CartChanged = Function(
  String? value,
  int? privilegeLevel,
);

/* 
 * CartDropdownButtonWidget is the drop down widget to allow to select an instance of Cart
 */
class CartDropdownButtonWidget extends StatefulWidget {
  ...
  /* 
   * construct a CartDropdownButtonWidget
   */
  CartDropdownButtonWidget(
      {required this.app,
      this.privilegeLevel,
      this.value,
      this.trigger,
  ...
  /* 
   * create state of CartDropdownButtonWidget
   */
  @override
  State<StatefulWidget> createState() {
    return _CartDropdownButtonWidgetState(value);
  }
}

class _CartDropdownButtonWidgetState extends State<CartDropdownButtonWidget> {
  CartListBloc? bloc;
  String? value;

  _CartDropdownButtonWidgetState(this.value);
  ...
  List<Widget> _widgets(CartModel value) {
    var app = widget.app;
    var widgets = <Widget>[];
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      items: items,
                      value: value,
                      hint: text(widget.app, context, 'Select a cart'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    label: 'Update',
                    onPressed: () {
                      updateComponent(context, widget.app, 'carts', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
